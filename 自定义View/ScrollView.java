...
/**
 * 两个看点：
 * 1 为什么scrollView会让listview的所有优化都无效，就是scrollView是让子view尽可能的大
 * 2 如何处理滚动的事件处理的
 */
public class ScrollView extends FrameLayout {
        ...
        */
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_MOVE: {
                ...
                * of the down event.
				* 比较和action_down时的y值进行比较，看是否滑动了足够远
                */
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                * being flinged.
				* 两种情况，一种是初始动作，ｄｏｗｎ，还有一种是flinged时的down,让动作停止
                */
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        MotionEvent vtev = MotionEvent.obtain(ev);//copy from ev
        ...
        switch (actionMasked) {
            case MotionEvent.ACTION_DOWN: {
				 ...
				 * 如果是正在flinged,那么就直接停止scroller的动画
                 */
