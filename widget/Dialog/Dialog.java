 ...
 * that managed this dialog.
 //TODO:Dialog和Activity的交互,双方可以使用方法来进行交互啊!!!!
 *
...
public class Dialog implements DialogInterface, Window.Callback,
    ...
    //TODO:很熟悉的几个类 Activity,Context,WindowsManager,Window,View
    ...
    Dialog(Context context, int theme, boolean createContextThemeWrapper) {
        ...
        //获得WindowManager和Window,我们知道的Dialog是存在单独的Window的
    ...
    public void show() {
        ...
        if (!mCreated) {
            ...
            dispatchOnCreate(null); //如果没有创建,会调用dispatchOnCreate然后调用onCreate方法
        }

        onStart();
        mDecor = mWindow.getDecorView();
        //判断是否有actionbar所以需要在show()之前就设置好window的特性
     ...
     *     is the first time.
     * TODO:Dialog的onCreate中没有实现任何逻辑,这是需要你去调用setContentView的方法的
     */
